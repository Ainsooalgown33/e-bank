...
myquery = "INSERT INTO accessbank (FirstName, LastName, contact, line, account_number, password, account_balance) VALUES (%s, %s, %s, %s, %s, %s, %s)"
def operation():
    global func
    print(""" Welcome to access bank, your bank of interest. what would you like to do?!!!
...
def membership():
    ...
    conn.commit()
    print(mycursor.rowcount, "bank record updated successfully, welcome to access bank " + firstName  +  lastName, " your account number is " + str(account_number))
...
def login():
    ...
    query = "SELECT * FROM accessbank WHERE account_number=%s AND password=%s"
    ...
    if result is not None:
        ...
        if option == "1":
            ...
            query = "UPDATE accessbank SET account_balance=%s WHERE account_number=%s"
